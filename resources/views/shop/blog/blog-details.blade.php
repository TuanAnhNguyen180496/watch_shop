...
<!--Page Banner Start-->
<div class="page-banner" style="background-image: url(../public/watchshop/images/banner/banner_blog.png);">
    <div class="container">
                        ...
                        <li>
                            <div class="single-post">
                                <div class="post-thumb">
                                    <a href="{{URL::to('/blog/'.$new_blog->BlogSlug)}}"><img src="{{asset('public/storage/watchshopdash/images/blog/'.$new_blog->BlogImage)}}" alt=""></a>
                                </div>
